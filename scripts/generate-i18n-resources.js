    ...
    namespaces.forEach((ns) => {
      ...
      fileChecks.push(
        fs.promises
          ...
          .catch(() => {
            console.warn(`Warning: Missing file ${filePath} (${fullPath})`);
            fileMap.set(`${lang}:${ns}`, {
              importName,
              filePath,
              exists: false,
...
async function generateResources() {
  ...
  // The language and the namespace array should maintain the multi-line format for better readability and maintainability.
  // The condensed single-line format makes it difficult to scan the supported languages and namespaces and increases the likelihood of merge conflicts.
