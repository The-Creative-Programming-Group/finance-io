...
const Home = () => {
  ...
  return (
    <ScrollView>
      ...
      <AppText className={"mt-10 text-dark-text font-bold text-center text-lg"}>{isLoaded && user ? `Hello ${user.firstName}! 👋` : 'undefined'}</AppText>
      ...
      {/*Input Fields*/}
      <AppText className="mt-5 ml-6 text-base text-text font-bold dark:text-dark-text">
        Bank Name
      </AppText>
      <View
        style={{
      ...
      <AppText className="mt-2 ml-6 text-base text-text font-bold dark:text-dark-text">
        Current Amount
      </AppText>
      <View
        style={{
      ...
      <TouchableOpacity
        className="mt-5 self-center rounded-xl bg-[#3d73e9] px-8 py-1.5"
      >
        <AppText 
